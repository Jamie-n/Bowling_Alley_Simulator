...
public class BowlingAlley {
    ...
    public void calculateScore(BowlingPlayer player, GridPane gridPane) {
        ...
        if (currentRound >= 1 || player.getThrow2(currentRound) + player.getThrow1(currentRound) != 10) {
            ...
            if (player.getOnSpare() || totalLastFrame == 10) {

                //Final round spare
                if (currentRound == 10 && player.getThrow2(currentRound - 2) + player.getThrow1(currentRound - 2) == 10) {
                    ...
                    if (!player.getOnSpare() && totalForFrame != 10) {
                        bonusPoints = totalLastFrame + player.getThrow1(currentRound);
